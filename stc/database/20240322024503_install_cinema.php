...
class InstallCinema extends Migrator
{
    ...
    private function _create_cinema_video()
    {
        ...
        $this->table($table, [
            ...
            ->addColumn('version', 'string', ['limit' => 180, 'default' => '', 'null' => true, 'comment' => '视频版本'])
            ->addColumn('hits', 'biginteger', ['limit' => 20, 'default' => 0, 'null' => true, 'comment' => '视频热度'])
            ...
            ->addColumn('region', 'string', ['limit' => 180, 'default' => '', 'null' => true, 'comment' => '地区'])
            ->addColumn('total', 'biginteger', ['limit' => 20, 'default' => 0, 'null' => true, 'comment' => '总集数'])
            ->addColumn('recommend', 'integer', ['limit' => 1, 'default' => 0, 'null' => true, 'comment' => '是否推荐 0否 1是'])
            ->addColumn('release_time', 'datetime', ['default' => NULL, 'null' => true, 'comment' => '上映时间'])
            ->addColumn('sort', 'biginteger', ['limit' => 20, 'default' => 0, 'null' => true, 'comment' => '排序权重'])
            ->addColumn('status', 'integer', ['limit' => 1, 'default' => 1, 'null' => true, 'comment' => '使用状态'])
            ->addColumn('create_time', 'datetime', ['default' => NULL, 'null' => true, 'comment' => '创建时间'])
            ->addColumn('update_time', 'datetime', ['default' => NULL, 'null' => true, 'comment' => '更新时间'])
    ...
    private function _create_cinema_video_line()
    {
        ...
        // 数据表
        $this->table($table, [
            'engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '视频-视频线路',
        ])
            ->addColumn('name', 'string', ['limit' => 180, 'default' => '', 'null' => true, 'comment' => '线路名称'])
            ->addColumn('video_id', 'biginteger', ['limit' => 20, 'default' => 0, 'null' => true, 'comment' => '视频ID'])
            ->addColumn('status', 'integer', ['limit' => 1, 'default' => 1, 'null' => true, 'comment' => '使用状态'])
            ->addColumn('sort', 'biginteger', ['limit' => 20, 'default' => 0, 'null' => true, 'comment' => '排序权重'])
            ->addColumn('create_time', 'datetime', ['default' => NULL, 'null' => true, 'comment' => '创建时间'])
            ->addColumn('update_time', 'datetime', ['default' => NULL, 'null' => true, 'comment' => '更新时间'])
            ->addIndex('sort', ['name' => 'idx_cinema_video_line_sort'])
            ->addIndex('status', ['name' => 'idx_cinema_video_line_status'])
            ->create();
    ...
    private function _create_cinema_video_play()
    {
        ...
        $this->table($table, [
            ...
            ->addColumn('play_url', 'string', ['limit' => 180, 'default' => '', 'null' => true, 'comment' => '播放地址'])
            ->addColumn('down_url', 'string', ['limit' => 180, 'default' => '', 'null' => true, 'comment' => '下载地址'])
            ->addColumn('status', 'integer', ['limit' => 1, 'default' => 1, 'null' => true, 'comment' => '使用状态'])
            ->addColumn('sort', 'biginteger', ['limit' => 20, 'default' => 0, 'null' => true, 'comment' => '排序权重'])
            ->addColumn('create_time', 'datetime', ['default' => NULL, 'null' => true, 'comment' => '创建时间'])
            ->addColumn('update_time', 'datetime', ['default' => NULL, 'null' => true, 'comment' => '更新时间'])
